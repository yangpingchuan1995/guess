...
Page({
  ...
  get_user_coin() {
    ...
    wx.request({
      url: 'https://www.kaaile.cn/current_bonus_card',
      data: '',
      header: header,
      success: function (res) {
        console.log(res)
        if (res.data.status == 200) {
          that.setData({
            ...
            checkpoint_num: res.data.checkpoint_num,
  ...
  submit_answer() {
    ...
    wx.request({
      url: 'https://www.kaaile.cn/bonus_card',
      data: {
        answer: answer
      },
      header: header,
  ...
  skip() {
    ...
    wx.request({
      url: 'https://www.kaaile.cn/skip_bonus_card',
      data: '',
      header: header,
      success: function (res) {
        setTimeout(function () {
